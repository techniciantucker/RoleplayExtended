...
Citizen.CreateThread( function()
	while true do
		...
		if ( IsControlJustReleased( 0, 311 ) or IsDisabledControlJustReleased( 0, 311 ) ) and GetLastInputMethod( 0 ) and not IsPauseMenuActive() and not blockinput and ((settings["adminOnlyTrainer"] == true and adminStatus == true) or settings["adminOnlyTrainer"] == false) then -- f1
		...
		if ( IsControlJustReleased( 0, 166 ) or IsDisabledControlJustReleased( 0, 166 ) ) and GetLastInputMethod( 0 ) and not blockinput and ((settings["adminOnlyTrainer"] == true and adminStatus == true) or settings["adminOnlyTrainer"] == false) then -- f3
			teleportToWaypoint()
		end

		if ( IsControlJustReleased( 0, 243 ) or IsDisabledControlJustReleased( 0, 243 ) ) and GetLastInputMethod( 0 ) and ((settings["adminOnlyNoclip"] == true and adminStatus == true) or settings["adminOnlyNoclip"] == false) then
			toggleNoClipMode()
		end
